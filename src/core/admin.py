...
class ActivityAdmin(admin.ModelAdmin):
    ...
    search_fields = ('name', )
    fields = ('aid', 'name', 'gold', 'rock', 'feat', 'hp', 'prods', 'nums', 'total', 'created_at', 'ended_at', 'channels')
    filter_vertical = ('channels', )

class CodeAdmin(admin.ModelAdmin):
    list_display = ('code', 'user', 'classify', 'type', 'valided_at', 'created_at', 'gold', 'rock', 'feat', 'hp', 'prods', 'nums')
    search_fields = ('code', )
    fields = ('code', 'user', 'classify', 'type', 'valided_at', 'created_at', 'gold', 'rock', 'feat', 'hp', 'prods', 'nums')
#    filter_vertical = ('channels', )
...
class DayRechargeAdmin(admin.ModelAdmin):
    list_display = ('rid', 'bigevent', 'name', 'gold', 'rock', 'feat', 'hp', 'prods', 'nums', 'total', 'type', 'created_at', 'ended_at')
    search_fields = ('name', )
    fields = ('rid', 'name', 'bigevent', 'gold', 'rock', 'feat', 'hp', 'prods', 'nums', 'total', 'type', 'channels', 'created_at', 'ended_at')
    filter_vertical = ('channels', )
...
class ConsumeAdmin(admin.ModelAdmin):
    list_display = ('rid', 'bigevent', 'name', 'gold', 'rock', 'feat', 'hp', 'prods', 'nums', 'total', 'type', 'created_at', 'ended_at')
    search_fields = ('name', )
    fields = ('rid', 'name', 'bigevent', 'gold', 'rock', 'feat', 'hp', 'prods', 'nums', 'total', 'type', 'created_at', 'ended_at')
...
class PropExchangeAdmin(admin.ModelAdmin):
    list_display = ('bigevent', 'rid', 'name', 'gold', 'rock', 'feat', 'hp', 'prods', 'nums', 'exgold', 'exrock', 'exfeat', 'exhp', 'exprods', 'exnums', 'times')
    search_fields = ('name', )
    fields = ('bigevent', 'rid', 'name', 'gold', 'rock', 'feat', 'hp', 'prods', 'nums', 'exgold', 'exrock', 'exfeat', 'exhp', 'exprods', 'exnums', 'times')
